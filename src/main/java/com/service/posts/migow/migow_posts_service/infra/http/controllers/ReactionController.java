...
public class ReactionController {
    ...
    private final UpdateReactionByIdUseCase updateReactionByIdUseCase;
    ...
    @PostMapping
    public SimpleReactionDTO createReaction(@RequestBody CreateReactionDTO obj) {     
        // TODO: provide created entity to kafka  
        return createReactionUseCase.execute(obj);
    }
    
    @PatchMapping("/{reactionId}")
    public SimpleReactionDTO updateReaction(@PathVariable UUID reactionId, @RequestBody UpdateReactionDTO obj) {
        // TODO: provide created entity to kafka
        return updateReactionByIdUseCase.execute(reactionId, obj);
    } 
